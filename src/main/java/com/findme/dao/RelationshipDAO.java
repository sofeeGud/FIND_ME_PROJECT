...
public class RelationshipDAO extends GeneralDAOImpl<Relationship>{
    ...
    public void saveRelationship(Long userFromId, Long userToId, RelationshipStatus status) throws BadRequestException {
        try {
    ...
    public void updateRelationship(Long userFromId_old, Long userToId_old, Long userFromId_new, Long userToId_new, RelationshipStatus status) throws BadRequestException {
        try {
    ...
    public Relationship getRelationship(String userFromId, String userToId) throws BadRequestException{
        try {
    ...
    public List<User> getIncomingRequests(String userId) throws BadRequestException {
        try {
        ...
        public List<User> getOutgoingRequests(String userId) throws BadRequestException{
            try {
    ...
    public List<User> getFriendsList(String userId) throws BadRequestException {
        try {
    ...
    public int getFriendsCount(String userId) throws BadRequestException {
        try {
